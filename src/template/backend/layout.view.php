    ...
    <main class="flex flex-col w-full h-full">
        <nav class="bg-white border-b h-16 text-sm font-medium text-slate-500">
            <div class="container flex justify-between mx-auto h-full relative items-center">
                ...
                <div class="ml-[90px] text-slate-500 flex h-full">
                    <a href="/admin" class="mr-7 text-slate-400 flex items-center">Storm CMS</a>
                    <div class="flex items-center border-b border-b-blue-400 mr-3 text-slate-800">
                        <a href="/admin/articles" class="px-1 border-b-blue-300">Articles</a>
                    </div>
                    <div class="hover:text-slate-600 hover:border-b border-b-blue-300 flex items-center mr-3">
                ...
                <a href="/admin/logout" class="pr-3 hover:text-slate-800">{{ $username }}, signout</a>
            </div>
        </nav>
        <div class="container mx-auto pt-5 pl-2">
            {% $content %}
        </div>
    </main>
</body>
